  ...
  return (
    <main className="w-full min-h-screen py-10 px-4">
      <div className="flex flex-col sm:flex-row justify-center items-center sm:items-start text-center gap-8 sm:gap-12 text-neutral-600">
        ...
        {/* Fixed image section */}
        <div className="relative group h-fit mt-8 opacity-0 animate-slidein [--slidein-delay:400ms] shrink-0">
          <Image
        ...
        <div className="flex flex-col font-sans gap-4 sm:mt-6 w-8/12 sm:w-1/3 text-center sm:text-left bg-[rgba(255,255,255,0.85)] backdrop-blur-sm p-6 rounded-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="flex flex-col gap-6 text-sm sm:text-base">
            ...
            <p className="animate-slidein opacity-0 [--slidein-delay:600ms]">I’m always eager to collaborate, learn, and innovate in the ever-evolving landscape of design. If you’re interested in working together or just want to chat about UX, digital art, or emerging technologies, feel free to reach out!</p>
          </div>
        </div>
      </div>
    </main>
